...
describe('total likes',()=>{
    ...
    const blogs = [
      ...
      test('of list with single blog is equal to its likes',()=>{
...
describe('favorite blog',()=>{
    ...
    const blogs = [
      ...
      test('of empty list is null object',()=>{
        const result = listHelper.favoriteBlog(emptyBlog)
        expect(result).toEqual(undefined)
      })  
      test('of list with single blog is the blog itself',()=>{
      ...
      test('of large list to return any blog with most likes',()=>{
...
describe('author with most blogs',()=>{
  ...
  test('in an empty blog is undefined',()=>{
    const result = listHelper.mostBlogs(emptyBlog)
    expect(result).toEqual(undefined)
  })
  test('in a blog is calculated',()=>{
...
describe('author with most likes',()=>{
  ...
  test('in a large blog to be correctly calculated',()=>{
